...
hd = pd.read_csv(os.path.join('sandp500', 'individual_stocks_5yr', 'individual_stocks_5yr', ticker + '_data.csv'),
...
# Using 100 units for better accuracy
# 1st LSTM layer
...
# Making a prediction of 2018 stocks specifically for NFLX TICKER
dataset_test = pd.read_csv(os.path.join('sandp500', 'individual_stocks_5yr', 'individual_stocks_5yr', 'NFLX_TEST.csv'),
                           delimiter=',', usecols=['date', 'open', 'high', 'low', 'close'])
